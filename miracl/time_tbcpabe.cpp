/*
   ...
   cl /O2 /GX time_tbcpabe.cpp cp_pair.cpp zzn2.cpp big.cpp zzn.cpp ecn.cpp miracl.lib

   For MR_PAIRING_MNT curve
   cl /O2 /GX time_tbcpabe.cpp mnt_pair.cpp zzn6a.cpp ecn3.cpp zzn3.cpp zzn2.cpp big.cpp zzn.cpp ecn.cpp miracl.lib

   For MR_PAIRING_BN curve
   cl /O2 /GX time_tbcpabe.cpp bn_pair.cpp zzn12a.cpp ecn2.cpp zzn4.cpp zzn2.cpp big.cpp zzn.cpp ecn.cpp miracl.lib

   For MR_PAIRING_KSS curve
   cl /O2 /GX time_tbcpabe.cpp kss_pair.cpp zzn18.cpp zzn6.cpp ecn3.cpp zzn3.cpp big.cpp zzn.cpp ecn.cpp miracl.lib

   For MR_PAIRING_BLS curve
   cl /O2 /GX time_tbcpabe.cpp bls_pair.cpp zzn24.cpp zzn8.cpp zzn4.cpp zzn2.cpp ecn4.cpp big.cpp zzn.cpp ecn.cpp miracl.lib
...
#define NATTR  30 // Universe of attributes
#define NALICE 5  // number of Alice's attributes
#define NBOB   5  // number of Bob's attributes
#define Nd     5  // number required in common

int Alice[NALICE]={1,2,3,4,5};    // Alice's attributes
int Bob[NBOB]=    {1,2,3,4,5};   // Bob's attributes
...
// Decryption by Bob
  ...
  for (j=0;j<NBOB;j++)
	...
	if (k<Nd)
	{
		cout << endl << "Bob does not have enough attributes in common with Alice to decrypt !!" << endl;
		//exit(0);
	}
  GT L;
  ...
  eq1=eq1*L;
	...
	GT Kt=pfc.power(eq1,moddiv(1,cof[0],order))*eq2;

	GT Mt=c3/Kt;
	if(Mt==M)
     cout<<endl<<"Decryption Success"<<endl;
  else
     cout<<endl<<"Decryption Fail !!"<<endl;
  END = clock();
